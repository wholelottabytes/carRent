        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalLocationId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdditionalServices_RentalLocations_RentalLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourRate = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_RentalLocations_RentalLocationId",
                        column: x => x.RentalLocationId,
                        principalTable: "RentalLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingAdditionalServices", x => new { x.BookingId, x.AdditionalServiceId });
                    table.ForeignKey(
                        name: "FK_BookingAdditionalServices_AdditionalServices_AdditionalServ~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionalServices_RentalLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_RentalLocationId",
                table: "Bookings",
                column: "RentalLocationId");
